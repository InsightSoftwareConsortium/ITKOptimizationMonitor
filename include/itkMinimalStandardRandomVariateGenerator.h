...
#include "OptimizationMonitorExport.h"
 ...
 *
 * \ingroup OptimizationMonitor
 */
class OptimizationMonitor_EXPORT MinimalStandardRandomVariateGenerator : public RandomVariateGeneratorBase
{
public:
